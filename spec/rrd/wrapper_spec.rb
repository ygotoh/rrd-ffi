...
describe RRD::Wrapper do
  ...
  context "when there is a rrd file" do
    ...
    it 'should xport values' do
      ...
      expect(values[0..-2]).to eq([["time", "Legend 0"], [1266933600, 0.0008], [1266937200, 0.0008], [1266940800, 0.0008]])
    end
  ...
  context "when using bang methods" do
    ...
    it "should list them" do
      expect(RRD::Wrapper.methods & RRD::Wrapper::BANG_METHODS).to eq(RRD::Wrapper::BANG_METHODS)
    end
